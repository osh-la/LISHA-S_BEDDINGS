...
Thank you.`;
  ...
  return (
    <div className="fixed top-0 right-0 w-full md:w-[400px] h-full bg-[#f4f0e9] shadow-lg z-50 p-6 overflow-y-auto flex flex-col">
      
      <button
        className="mb-4 text-red-500 font-bold self-start"
        onClick={onClose}
      >
        Close
      </button>
        ...
        <>
          <div className="flex-1">
            {cart.map((item, i) => (
              <div
                key={i}
                className="mb-3 border-b pb-2 flex items-center gap-2"
              >
                <img
